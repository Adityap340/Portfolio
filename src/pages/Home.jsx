...
const Home = () => {
  return (
    <div className='gradient__bg flex flex-col md:flex-row items-center justify-center h-screen'>
      <div className='md:w-1/2 text-center md:text-left md:pr-8 px-32'>
        <h2 className='font-semibold text-slate-400 hii'>Hi,</h2>
        <h1 className='text-8xl font-bold mb-4 text-slate-200'>I'm<br/>Aditya Patil</h1>
      ...
      <div className='md:w-1/2 relative'>
        <img
          className='rounded-lg w-3/4 h-auto animated-image'
          src={abstractPic}
          alt='Hero'
        />
      </div>
